...
const Header = () => {
  ...
  return (
    <div className="fixed bg-black  px-2 py-6 h-[80px] z-30 flex flex-row w-full bottom-0 border-t items-center | md:items-start md:border-t-0 md:flex-col md:h-screen md:w-1/12 md:border-r | lg:w-2/12">
